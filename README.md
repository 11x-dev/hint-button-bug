1. Locate the file that contains the hint button, one simple way is to right click the hint button, then click inspect.  This will automatically show you the html of that in the browser.
